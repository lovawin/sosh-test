...
// Mock data without UI-specific elements (icons, colors)
export const mockInsights: Record<SocialPlatform, PlatformInsights> = {
  twitter: {
    insights: [
      {
...
export const getMockInsights = (platform: SocialPlatform): InsightData[] => {
  return mockInsights[platform].insights;
};
