  ...
  return (
    ...
    <Main>
      ...
      <HeadDiv>
        <MainDesc>
          {profile_image_url ? (
            <ProfileImg src={profile_image_url} rounded />
          ) : (
            <ProfileImg src="user.png" rounded />
          )}
      ...
      <ButtonSec>
        ...
        <Link to="/edit-profile">
          ...
          <Div>
            <Image src="edit.png" />
            <NameSpan>Edit Profile</NameSpan>
          </Div>
        </Link>
        <Div>
          <Image onClick={disconnect} src="disconnect.png" />

          <NameSpan onClick={disconnect}>Disconnect Wallet</NameSpan>
        </Div>
      </ButtonSec>
      <hr />
      <AddressSec>
      ...
      <ItemSec>
        ...
        <Items>Staking pools</Items>
        <Items>Privacy Policy</Items>
        <Items>Disclamers</Items>
        <Items>Purchaser Creator Agreement</Items>
        <Items>Technical Support</Items>
      </ItemSec>
      <SocialSec>
        <svg
