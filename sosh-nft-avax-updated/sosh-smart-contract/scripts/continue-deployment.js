// Script to continue deployment from NFT contract
...
const deployedAddresses = {
  treasury: "0x6B93d11526086B43E93c0B6AD7375d8105Ce562A", // Already deployed Treasury contract
  nft: null,
  marketplace: null
};

async function main() {
  console.log("Continuing deployment with new admin wallet...");
  ...
  // Step 1: Deploy NFT
  console.log("\n=== Step 1: Deploying NFT Contract ===");
  await deployNFT();
  
  // Step 2: Deploy Marketplace
  console.log("\n=== Step 2: Deploying Marketplace Contract ===");
  await deployMarketplace();
  
  // Step 3: Update NFT with Marketplace address
  console.log("\n=== Step 3: Updating NFT with Marketplace Address ===");
  await updateNFTWithMarketplace();
  
  // Step 4: Save deployed addresses to .env file
  console.log("\n=== Step 4: Saving Deployed Addresses ===");
  await saveAddressesToEnv();
  
  // Step 5: Verify admin rights
  console.log("\n=== Step 5: Verifying Admin Rights ===");
